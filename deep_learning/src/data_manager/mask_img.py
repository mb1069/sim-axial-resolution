...
# Used to mask single layers out of training points 

output_dir = 'benchmark/masked_raw_imgs/'
shutil.rmtree(output_dir, ignore_errors=True)
os.makedirs(output_dir, exist_ok=True)

in_img_dir = 'benchmark/raw_imgs/'

in_img = 'benchmark/raw_imgs/27_struct_in.tif'
