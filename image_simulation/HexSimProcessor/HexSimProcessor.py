...
from numpy import exp, pi, sqrt, arccos
from image_simulation.HexSimProcessor.pyczt import pyczt
...
class HexSimProcessor:
    ...
    def fake_calibrate(self, img):
        ...
        ckx = [-0.9996789, -0.9991627, -1.9990363]
        cky = [1.7319897, -1.731256, 0.00019474]
        p = [2.2386158, 1.3692364, 0.47546214]
        ampl = [0.34640652, 0.31910774, 0.3282621]
        # kmax = 0.97746325
        # ckx = [-kmax, -kmax, -2 * kmax]
        # cky = [math.sqrt(3) * kmax, -sqrt(3) * kmax, 0]
        # p = [5 * math.pi / 7, 3 * math.pi / 7, math.pi / 7]
        # ampl = [1 / 3] * 3
