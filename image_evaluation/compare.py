...
# 3  142.943023  0.000000  1.000000    0_0_1000points_in.tif  reference
# 0  137.332121  0.000739  0.963764    0_0_1000points_in.tif        sim
# 4  504.543470  0.000000  1.000000  10_0_11000points_in.tif  reference
# 1   76.800356  0.002111  0.952516  10_0_11000points_in.tif        sim
# 5  689.217306  0.000000  1.000000   9_0_10000points_in.tif  reference
# 2   76.800411  0.001940  0.953824   9_0_10000points_in.tif        sim
            # Summing method
            # inv_fft_spectrum = fftpack.ifftn(inv_fft_spectrum)
            # inv_fft_spectrum = inv_fft_spectrum.mean(axis=0)
...
if __name__ == '__main__':
    ...
    all_models = glob.glob(os.path.join(models_dir, 'MSE_2D_RCAN_w_3D_Conv_300_epochs_*chunk.pth')) + non_model_comparisons
    ...
    final_models_w_ref = glob.glob(os.path.join(models_dir, 'MSE_2D_RCAN_w_3D_Conv_300_epochs_3chunk.pth')) + non_model_comparisons
